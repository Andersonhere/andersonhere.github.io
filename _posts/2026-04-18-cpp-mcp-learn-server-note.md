...
date: 2026-04-18 21:42:44 +0800
categories: [C++, 工具链, MCP]
tags: [MCP, cpp-mcp, Cursor, C++, JSON-RPC, hkr04]
---

> **原文（维护源）**：[MCP实现与学习笔记.md](https://github.com/Andersonhere/WorkGuide/blob/master/gq_mcp/mcp/MCP实现与学习笔记.md)（修订以 WorkGuide 仓库内该路径为准；本文为发布副本。）
>
> **相关目录**：[gq_mcp/mcp/](https://github.com/Andersonhere/WorkGuide/tree/master/gq_mcp/mcp)
